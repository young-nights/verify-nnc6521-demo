 ...
 *  Chip 1: MOSI=PA7(SPI1_MOSI), CSN=PA4(SPI1_CS), SCLK=PA5(SPI1_CLK),
 *          MISO=PA6(SPI1_MISO), CHIP_EN=PC5, INTB=PC4
 *  Chip 2: MOSI=PB15(SPI2_MOSI), CSN=PB12(SPI2_CS), SCLK=PB13(SPI2_CLK),
 *          MISO=PB14(SPI2_MISO), CHIP_EN=PC7, INTB=PC6
 * ===========================================================================*/
