...
/* Chip 1 pin mapping: MOSI=PA7, CSN=PA4, SCLK=PA5, MISO=PA6, CHIP_EN=PC5, INTB=PC4 */
/* Chip 2 pin mapping: MOSI=PB15, CSN=PB12, SCLK=PB13, MISO=PB14, CHIP_EN=PC7, INTB=PC6 */
